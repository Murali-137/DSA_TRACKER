...
export const LogoIcon = ({ size = 28 }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
    ...
    <path d="M8 22L14 10l4 8 3-5 4 9" stroke="#fff" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
    <defs>
...
export const SparklesIcon = ({ size = 20, color = '#a855f7' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6L12 2z" fill={color} opacity="0.9"/>
  </svg>
);
...
export const TrophyIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M7 4H4a2 2 0 00-2 2v2a4 4 0 004 4h.5"/><path d="M17 4h3a2 2 0 012 2v2a4 4 0 01-4 4h-.5"/>
    <path d="M7 4a5 5 0 0010 0V2H7v2z"/>
  </svg>
);
...
export const BookOpenIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const StarIcon = ({ size = 16, filled = false }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? '#a855f7' : 'none'} stroke="#a855f7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
